...
import { a as joinRelativeURL, b as useRuntimeConfig, d as defineRenderHandler, c as getQuery, e as createError, f as getRouteRules, h as getResponseStatus, i as getResponseStatusText, u as useNitroApp } from '../_/nitro.mjs';
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"A platform dedicated to emotional support and mental well-being"}],"link":[],"style":[],"script":[],"noscript":[],"title":"Emotional Support Platform"};
